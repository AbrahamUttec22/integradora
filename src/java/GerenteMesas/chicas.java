...
@WebServlet(name = "chicas", urlPatterns = {"/chicas"})
public class chicas extends HttpServlet {
     ResultSet cdr=null;
  ...
  @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet chicas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet chicas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
out.print("<td><input  type='submit' id='mesas"+i+"'   class='chicasOcupadas' value="+ocupado[i]+" onclick='cotizar"+i+"();'></td>");
...
out.print("<td><input type='button' class='chicasDisponibles' value="+mesas[i]+" ></td>");
