...
@WebServlet(name = "grandes", urlPatterns = {"/grandes"})
public class grandes extends HttpServlet {
  ...
  @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet grandes</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet grandes at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
out.print("<td><input  type='submit' id='mesas"+i+"' class='grandesOcupadas' value="+ocupado[i]+" onclick='cotizar"+i+"();'></td>");
...
out.print("<td><input type='button'  class='grandesDisponibles' value="+mesas[i]+" ></td>");
