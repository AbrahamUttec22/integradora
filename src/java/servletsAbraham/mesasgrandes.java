...
@WebServlet(name = "mesasgrandes", urlPatterns = {"/mesasgrandes"})
public class mesasgrandes extends HttpServlet {
   ResultSet cdr=null;
  ...
  @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet mesasgrandes</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet mesasgrandes at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
  ...
  ////////////////////////////////////////////////////////////////// 
       response.setContentType("text/html;charset=UTF-8");
           String mesas[]={"g1","g2","g3","g4","g5","g6","g7","g8","g9","g10"};
...
out.print("<td><input  type='submit'  class='grandesOcupadas' value="+ocupado[i]+"></td>");
...
out.print("<td><input type='button' id='mesas"+i+"' class='grandesDisponibles' value="+mesas[i]+" onclick='cotizar"+i+"();'></td>");
  ...
  //////////////////////////////////SOLO COPIAR LA MESA DE OTRO DIA //////////////////////////////7
