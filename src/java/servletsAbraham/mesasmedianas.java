...
@WebServlet(name = "mesasmedianas", urlPatterns = {"/mesasmedianas"})
public class mesasmedianas extends HttpServlet {
  ...
  @Override
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet mesasmedianas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet mesasmedianas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
out.print("<td><input  type='submit'  class='medianasOcupadas' value="+ocupado[i]+"></td>");
...
out.print("<td><input type='button' id='mesas"+i+"' class='medianasDisponibles' value="+mesas[i]+" onclick='cotizar"+i+"();'></td>");
