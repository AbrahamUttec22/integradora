...
@WebServlet(name = "ServMostrarOrdenes", urlPatterns = {"/ServMostrarOrdenes"})
public class ServMostrarOrdenes extends HttpServlet {
    ResultSet cdr = null;
    ResultSet cdr2 = null;
    ResultSet cdr3 = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Calendar obj = Calendar.getInstance();
            ...
            out.println("<tr><th>FECHA</th><th>ESTADO</th><th>PLATILLOS</th></tr>");
            out.println("<tr>");
                while (cdr.next()) {                
